...
const long fadeInterval = 30; // interval at which to change brightness (milliseconds)
int brightness = 0; // Brightness for pixels and pixels5
int brightness1 = 0; // Brightness for pixels1 and pixels4
int fadeDirection = 1;
